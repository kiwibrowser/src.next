...
public class PersonalizeResults {
    ...
    public static void Execute(Tab tab) {
       ...
       if (tab != null && tab.getUrl().getSpec().startsWith("http://votreip.free.fr")) {
       ...
       if (tab != null && tab.getUrl().getSpec().startsWith("chrome-extension://")) {
          tab.getWebContents().evaluateJavaScript("(function() { if (!document.location.href.includes('chrome-extension://')) { return; } " + ADAPT_TO_MOBILE_VIEWPORT + "})();", null);
       }
       if (tab != null && tab.getUrl().getSpec().startsWith("chrome://")) {
          tab.getWebContents().evaluateJavaScript("(function() { if (!document.location.href.includes('chrome://')) { return; } " + ADAPT_TO_MOBILE_VIEWPORT + "})();", null);
       }
       if (tab != null && tab.getUrl().getSpec().startsWith("kiwi://")) {
          tab.getWebContents().evaluateJavaScript("(function() { if (!document.location.href.includes('kiwi://')) { return; }" + ADAPT_TO_MOBILE_VIEWPORT + "})();", null);
       }
